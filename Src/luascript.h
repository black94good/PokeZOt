...
class LuaScriptInterface
{
	...
	protected:
		...
		static int32_t luaSetMovePokemon(lua_State* L);
		static int32_t luaGetMovePokemon(lua_State* L);	
		...
		static int32_t luaDoSummonGuardian(lua_State* L);
		static int32_t luaGetCreatureGuardians(lua_State* L);
		static int32_t luaIsGuardian(lua_State* L);
