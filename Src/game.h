...
class Game
{
	public:
		...
		//Viktor
		ReturnValue placeGuardian(Creature* creature, const std::string& name);
		...
		//poke system
		bool doPlayerAddItemStacking(Player* player, Container* container, uint16_t itemid, uint8_t quant);
