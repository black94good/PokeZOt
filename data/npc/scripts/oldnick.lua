...
doEditName("C:/Users/WAGNER DOS SANTOS/Desktop/ot/Pokemon Dash/data/monster/pokemon/nicked/"..newarch..".xml", finalname, getItemAttribute(getPlayerSlotItem(cid, 8).uid, "poke"))
