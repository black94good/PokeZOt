...
------------#Configurações#----------------
local config = {
	tp1 = {x=1068, y=776, z=15}, -- coordenadas pra onde ele irá ao falar aonde está "boxs".
	item1 = 14662,  -- id do item 1
...
------------#*#Início do NPC#*#--------------
if msgcontains(msg, 'megabox') then -- o que ele tem que falar.
