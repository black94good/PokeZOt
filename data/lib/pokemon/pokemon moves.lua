...
doSetCreatureOutfit(cid, {lookType = 1711}, -1)
setPlayerStorageValue(cid, 9658783, 1)
addEvent(sendAtk, 2000, cid)  
...
elseif spell == "Ground Crushers" then
...
doSetCreatureOutfit(cid, {lookType = 1718}, -1)
stopNow(cid, 16*360)
addEvent(endMove, 16*360, cid)
----
for i = 0, 4 do
...
["Shiny Scizor"] = {out = 1725, cima = 128, direita = 129, esquerda = 130, baixo = 131},  --Shiny Scizor
