...
local a = io.open("data/pokemon/creatures.xml", "w")
local ex = io.open("data/pokemon/extensions.xml", "w")
...
local outfit = ""
	...
	for b = 1, #oldpokedex do
		...
		local kk = io.open("data/monster/pokemon/"..poke..".xml", "a+")
			if kk then
...
print("creatures.xml (data/pokemon/creatures.xml) done.")	
